...
func (c *hashTableClient) Put(ctx context.Context, in *PutRequest, opts ...grpc.CallOption) (*PutResponse, error) {
	out := new(PutResponse)
	err := c.cc.Invoke(ctx, "/dht.HashTable/Put", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *hashTableClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/dht.HashTable/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedHashTableServer
...
// UnimplementedHashTableServer should be embedded to have forward compatible implementations.
